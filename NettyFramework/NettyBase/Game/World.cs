        ...
        private static void InitiateWorld()
        {
            foreach (var map in StorageManager.Spacemaps)
            {
                ...
                if (map.Key == 16)
                {
                    ...
                    #region POIs
                    map.Value.CreatePOI(new POI("poi_01", world.objects.map.pois.Types.NO_ACCESS,
                    ...
                    map.Value.CreatePOI(new POI("poi_02", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_03", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_04", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_05", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_06", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_07", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_08", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_09", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_10", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_11", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_12", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_13", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_14", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_15", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_16", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_17", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_18", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_19", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_20", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_21", world.objects.map.pois.Types.NO_ACCESS,
                    ...
                    map.Value.CreatePOI(new POI("poi_22", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_23", world.objects.map.pois.Types.NO_ACCESS,
                        Designs.SIMPLE, Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_24", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_25", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_26", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_27", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_28", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_29", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_30", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_31", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_32", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_33", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                            new Vector(0, 13000),
                    ...
                    map.Value.CreatePOI(new POI("poi_34", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_35", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_36", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_37", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_38", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_39", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_40", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_41", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_42", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
                    ...
                    map.Value.CreatePOI(new POI("poi_43", world.objects.map.pois.Types.NO_ACCESS, Designs.SIMPLE,
                        Shapes.RECTANGLE,
                        new List<Vector>
                        {
