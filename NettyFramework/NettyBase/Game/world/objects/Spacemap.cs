...
using NettyBase.Game.world.objects.map.objects.jumpgates;
using NettyBase.Game.world.objects.map.objects.stations;
using NettyBase.Game.world.objects.map.ores;
using NettyBase.Game.world.objects.map.pois;
using NettyBase.Game.world.objects.map.zones;
using NettyBase.Game.world.objects.map.zones.pallazones;
...
using Types = NettyBase.Game.world.objects.map.collectables.Types;
...
namespace NettyBase.Game.world.objects
{
    class Spacemap : ITick
    {
        ...
        public void CreatePalladiumField()
        {
            ...
            CreatePOI(new POI("smoke_01", map.pois.Types.GENERIC, Designs.NEBULA, Shapes.RECTANGLE, new List<Vector> { new Vector(0, 16200), new Vector(5000, 25500), new Vector(0, 25500), new Vector(5000, 16200) }));

            zoneId = GetNextZoneId();
            zone = new PalladiumZone2(zoneId);
            Zones.Add(zoneId, zone);
            CreatePOI(new POI("smoke_02", map.pois.Types.GENERIC, Designs.NEBULA, Shapes.RECTANGLE, new List<Vector> { new Vector(4900, 17700), new Vector(5800, 25400), new Vector(4900, 25400), new Vector(5800, 17700) }));

            zoneId = GetNextZoneId();
            zone = new PalladiumZone3(zoneId);
            Zones.Add(zoneId, zone);
            CreatePOI(new POI("smoke_03", map.pois.Types.GENERIC, Designs.NEBULA, Shapes.RECTANGLE, new List<Vector> { new Vector(5700, 18800), new Vector(7700, 25500), new Vector(5700, 25500), new Vector(7700, 18800) }));

            zoneId = GetNextZoneId();
            zone = new PalladiumZone4(zoneId);
            Zones.Add(zoneId, zone);
            CreatePOI(new POI("smoke_04", map.pois.Types.GENERIC, Designs.NEBULA, Shapes.RECTANGLE, new List<Vector> { new Vector(7600, 21100), new Vector(24700, 25500), new Vector(7600, 25500), new Vector(24700, 21100) }));

            zoneId = GetNextZoneId();
            zone = new PalladiumZone5(zoneId);
            Zones.Add(zoneId, zone);
            CreatePOI(new POI("smoke_05", map.pois.Types.GENERIC, Designs.NEBULA, Shapes.RECTANGLE, new List<Vector> { new Vector(14600, 20600), new Vector(24700, 21100), new Vector(14600, 21100), new Vector(24700, 20600) }));

            zoneId = GetNextZoneId();
            zone = new PalladiumZone6(zoneId);
            Zones.Add(zoneId, zone);
            CreatePOI(new POI("smoke_06", map.pois.Types.GENERIC, Designs.NEBULA, Shapes.RECTANGLE, new List<Vector> { new Vector(7600, 20700), new Vector(12300, 21500), new Vector(7600, 21500), new Vector(12300, 20700) }));
